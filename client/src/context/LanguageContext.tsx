...
export type Translations = {
  ...
  bookViewer: {
    ...
    yourGeneratedBook: string;
    pageXofY: string;
    generatedByAI: string;
    browseThisBook: string;
    navigationButtons: string;
    navigationTip: string;
    chapterNavTip: string;
    chapter: string;
    previous: string;
    next: string;
    morePages: string;
...
const translations: Record<Language, Translations> = {
  en: {
    ...
    bookViewer: {
      ...
      yourGeneratedBook: 'Your Generated Book',
      pageXofY: 'Page {current} of {total}',
      generatedByAI: 'Generated by AI',
      browseThisBook: 'Browse this book',
      navigationButtons: 'Use the navigation buttons above and below to view all pages',
      navigationTip: 'Navigation Tip',
      chapterNavTip: 'Click on any chapter to jump directly to it, or use the navigation buttons to browse page by page.',
      chapter: 'Chapter',
      previous: 'Previous',
      next: 'Next',
    ...
    generationProgress: {
      ...
      waitMessage: 'Please wait while we generate your content...',
      complete: 'Complete',
      percentComplete: '% complete',
      alertMessage: 'Creating your book may take a few minutes. We\'re generating high-quality content customized to your specifications.'
    },
    notFound: {
  ...
  pt: {
    ...
    bookViewer: {
      ...
      yourGeneratedBook: 'Seu Livro Gerado',
      pageXofY: 'Página {current} de {total}',
      generatedByAI: 'Gerado por IA',
      browseThisBook: 'Navegue neste livro',
      navigationButtons: 'Use os botões de navegação acima e abaixo para visualizar todas as páginas',
      navigationTip: 'Dica de Navegação',
      chapterNavTip: 'Clique em qualquer capítulo para ir diretamente para ele, ou use os botões de navegação para navegar página por página.',
      chapter: 'Capítulo',
      previous: 'Anterior',
      next: 'Próxima',
      morePages: '+ {count} mais páginas',
    },
    generationProgress: {
      ...
      waitMessage: 'Por favor, aguarde enquanto geramos seu conteúdo...',
      complete: 'Concluído',
      percentComplete: '% concluído',
      alertMessage: 'A criação do seu livro pode levar alguns minutos. Estamos gerando conteúdo de alta qualidade personalizado de acordo com suas especificações.'
    },
    notFound: {
  ...
  es: {
    ...
    bookViewer: {
      ...
      previousPage: 'Página Anterior',
      tableOfContents: 'Índice',
      yourGeneratedBook: 'Tu Libro Generado',
      pageXofY: 'Página {current} de {total}',
      generatedByAI: 'Generado por IA',
      browseThisBook: 'Navega por este libro',
      navigationButtons: 'Usa los botones de navegación arriba y abajo para ver todas las páginas',
      navigationTip: 'Consejo de Navegación',
      chapterNavTip: 'Haz clic en cualquier capítulo para ir directamente a él, o usa los botones de navegación para navegar página por página.',
      chapter: 'Capítulo',
      previous: 'Anterior',
      next: 'Siguiente',
      morePages: '+ {count} más páginas',
    },
    generationProgress: {
      ...
      waitMessage: 'Por favor, espera mientras generamos tu contenido...',
      complete: 'Completado',
      percentComplete: '% completado',
      alertMessage: 'La creación de tu libro puede tardar unos minutos. Estamos generando contenido de alta calidad personalizado según tus especificaciones.'
    },
    notFound: {
